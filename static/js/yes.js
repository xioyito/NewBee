...
var darkHTML =
	"<link rel='stylesheet' href='/css/style-dark.css' /><link rel='stylesheet' href='/css/syntax-dark.css' />";
...
if (
	(isDark && sessionStorage.getItem("mode") != "light") ||
...
$(document).ready(function () {
	...
	$(".mode").click(function () {
		if (sessionStorage.getItem("mode") == "light") {
			...
			$(
				"link[href='/css/style-dark.css'], link[href='/css/syntax-dark.css']"
			).remove();
			$(".sun").show();
			$(".moon").hide();
			sessionStorage.setItem("mode", "light");
	...
	function createDir(theItem) {
		...
		if (nodeNameCustom == "H1") {
			count_h1++;
			titleHtml =
				'<div class="mulu-item heading1" id="mulu-' +
				titleId +
				'">' +
			...
			count_h2++;
			titleHtml =
				'<div class="mulu-item heading2" id="mulu-' +
				titleId +
				'">' +
				'<div class="shu-lan"></div>' +
				"<span>" +
	...
	$(".tosides-2").click(function () {
		...
		$(".tosides-1").show();
		$(".tosides-2").hide();
		$(".zhuti-l").css("min-width", "calc(100% - 310px)"); // bug
